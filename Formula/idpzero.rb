class Idpzero < Formula
  desc "Local IdP for development and testing purposes, single binary with zero addition dependencies"
  homepage "https://idpzero.dev"
  url "https://github.com/idpzero/idpzero/archive/v0.1.0.tar.gz"
